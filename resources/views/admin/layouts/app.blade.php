...
<head>
    ...
    <title id="page-title">{{ $page_name ?? 'Dashboard' }}</title>
    <link rel="apple-touch-icon" href="/app-assets/images/ico/apple-icon-120.png">
    <link rel="shortcut icon" type="image/x-icon" href="../../../app-assets\images\logo\Logodoanxem.png">
            ...
            <li class="nav-item">
                <a class="navbar-brand" href="{{ route('admin.home') }}">
                   <span class="brand-logo">
                       <img src="../../../app-assets\images\logo\Logodoanxem.png">
                   </span>
                    <h2 class="brand-text mb-0">Đoán Xem</h2>
                </a>
            </li>
        </ul>
    </div>
            ...
            <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                    ...
                    <a class="dropdown-item"
                       ...
                       role="menuitem">
                        <i aria-hidden="true" data-feather="power"></i>
                        Logout
                    </a>
...
<ul class="main-search-list-defaultlist d-none">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-conten-tbetween w-100"
                                   href="app-file-manager.html">
            <div class="d-flex">
...
{{--                                <h5>Tổng lượt truy cập</h5>--}}
                                <p class="card-text font-small-3">Tổng lượt truy cập</p>
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                                        <div class="d-flex flex-row">
                                            ...
                                            <div class="my-auto">
                                                <h4 class="fw-bolder mb-0">{{ $total_post }}</h4>
                                    ...
                                    <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                                        <div class="d-flex flex-row">
                                            ...
                                            <div class="my-auto">
                                                ...
                                                <p class="card-text font-small-3 mb-0">Người dùng</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-sm-0">
                                        <div class="d-flex flex-row">
                                            ...
                                            <div class="my-auto">
                                                <h4 class="fw-bolder mb-0">{{ $total_post_hide }}</h4>
                                                <p class="card-text font-small-3 mb-0">Bài viết bị ẩn</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-sm-6 col-12">
                                        <div class="d-flex flex-row">
                                            ...
                                            <div class="my-auto">
                                                <h4 class="fw-bolder mb-0" id="count_user">0</h4>
...
<!-- END: Page Vendor JS-->
<script src="https://cdnjs.cloudflare.com/ajax/libs/laravel-echo/1.13.1/echo.js" integrity="sha512-JGplK7GiJXdQMWynC+WDcy92i5SVBDO9lMRmVqhBT9ZSIAphsmrc/asOiJN1WUZDk26zZZcQubfOuRMiUfb7Ag==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<!-- BEGIN: Theme JS-->
...
<script src="/app-assets/js/api.js"></script>
